...
<html>
  ...
  <!-- Bootstrap 3.3.5 -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/ionicons.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
  folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/skins/_all-skins.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <!-- <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/morris/morris.css"> -->
  <!-- jvectormap -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/daterangepicker/daterangepicker-bs3.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!-- GROWL NOTIFICATION -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/jquery.growl.css">
  <!-- SELECT2 -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/select2.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/datatables/dataTables.bootstrap.css">
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/datatables/extensions/FixedColumns/css/dataTables.fixedColumns.min.css"></script>
  <link rel="stylesheet" href="http://localhost/sitempe/assets/plugins/datatables/extensions/TableTools/css/dataTables.tableTools.min.css"></script>
  <!-- Theme style -->
  <link rel="stylesheet" href="http://localhost/sitempe/assets/css/AdminLTE.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini">SITEMPE</span>
          <span class="logo-lg">SITEMPE</span>
        </a>
          ...
          <div class="navbar-custom-menu" >
            <ul class="nav navbar-nav">
              <li class="dropdown tasks-menu">
                <a href="http://localhost/sitempe/login/logout/">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
                            <img src="http://localhost/sitempe/assets/img/avatar04.png" alt="Kholiq" title="Kholiq" width="40" height="40" class=""/>            </div>
 ...
 <script src="http://code.jquery.com/jquery-1.9.1.js"></script>
    <script type="text/javascript" src="http://localhost/sitempe/assets/js/jquery-ui.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/pace/pace.min.js"></script>    <!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
    <!-- Bootstrap 3.3.5 -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/js/bootstrap.min.js"></script>
    <!-- Select2 -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/select2/select2.full.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/fileinput.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/ajaxFileUpload.js"></script>    <!-- Morris.js charts -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <!-- Sparkline -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/sparkline/jquery.sparkline.min.js"></script>    <!-- jvectormap -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js"></script>    <!-- jQuery Knob Chart -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/knob/jquery.knob.js"></script>    <!-- daterangepicker -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/js/moment.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/ckeditor.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/daterangepicker/daterangepicker.js"></script>    <!-- datepicker -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/datepicker/bootstrap-datepicker.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/autocomplete/jquery.autocomplete.js"></script>    <!-- Bootstrap WYSIHTML5 -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>    <!-- Slimscroll -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/slimScroll/jquery.slimscroll.min.js"></script>    <!-- FastClick -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/fastclick/fastclick.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>    <!-- AdminLTE App -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/js/jquery.blockUI.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/app.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/bootapp_back.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
    <!-- GROWL NOTIFICATION -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/js/jquery.growl.js"></script>

    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/input-mask/jquery.inputmask.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/input-mask/jquery.inputmask.extensions.js"></script>
    <!-- DataTables -->
    <script type="text/javascript" src="http://localhost/sitempe/assets/plugins/datatables/jquery.dataTables.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/datatables/dataTables.bootstrap.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/datatables/extensions/FixedColumns/js/dataTables.fixedColumns.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js"></script>    <script type="text/javascript" src="http://localhost/laboratorium_siladu/assets/js/dataTables.fixedColumns.min.js"></script>
    <script>
    $(document).ajaxStart(function() { Pace.restart(); });
    var site = 'http://localhost/sitempe/';
    var base = 'http://localhost/sitempe/';
    var gbr1 = 'http://localhost/sitempe/assets/img/loaders/biru.jpg'
    var gbr2 = 'http://localhost/sitempe/assets/img/loaders/4.gif'
