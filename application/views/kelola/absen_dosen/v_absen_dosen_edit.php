...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <?php echo form_input(array('name'=>'nomor_induk_pegawai','value'=>$row->nomor_induk_pegawai,'class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'nama_lengakp','value'=>$row->nama_lengkap,'class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"kelola/absen_dosen/show_editForm/","#divsubcontent")','Simpan','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
