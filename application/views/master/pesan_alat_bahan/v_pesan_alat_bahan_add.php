...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">Pemesanan Alat dan Bahan</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"master/pesan_alat_bahan/show_addForm/","#divsubcontent")','Save','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
