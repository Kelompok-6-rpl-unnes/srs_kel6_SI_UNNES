...
class M_kelola_bahan extends CI_Model
{
    ...
    {
        $this->db->select('kelola_bahan.*, master_bahan.nama_bahan, master_satuan.Nama, master_kategori_bahan.Kategori, master_sumber_pendanaan.sumber_pendanaan, lokasi_penyimpanan.nama_lokasi_penyimpanan');
		...
		$this->db->join('master_kategori_bahan', 'master_kategori_bahan.id = kelola_bahan.kategori');
