        ...
        <div class="box box-primary">
          ...
          <tr>
            ...
            <?php
              ...
              ?>
              <a href="<?= site_url('master/sumber_pendanaan/delete/'.$row->id) ?>" class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus Tipe Lab ?')"><i class="fa fa-trash"></i></a>
            </td>
          </tr>
